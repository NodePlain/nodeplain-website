    ...
    return (
        <div className="relative w-full h-full flex items-center justify-center">
            ...
            <div className="w-[140px] h-[200px] bg-white rounded-[20px] border-[4px] border-stone/10 shadow-lg relative overflow-hidden flex flex-col p-3 gap-2">
                {/* Incoming Message */}
                <div className="bg-amber/10 p-2 rounded-lg rounded-tl-none self-start max-w-[80%] animate-ghost-message">
                ...
                <div className="bg-stone/10 p-2 rounded-lg rounded-tr-none self-end flex gap-1 items-center animate-ghost-typing">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-white/80 animate-ghost-appear">
...
export function GraphicAgencyCarousel() {
    return (
        <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
            <div className="relative w-[180px] h-[180px] rounded-full border border-stone/10 animate-spin-slow">
                {/* Agency Logos (Shapes) */}
    ...
    return (
        <div className="relative w-full h-full flex flex-col items-center justify-center pt-8">
            ...
            <div className="w-[70%] h-[120px] bg-white/60 rounded-lg overflow-hidden relative border border-stone/5">
                {/* Scroll Container */}
                <div className="flex flex-col animate-search-scroll">
                    {/* Competitors (Top) */}
                    {[1, 2, 3].map((i) => (
    ...
    return (
        <div className="relative w-full h-full flex items-center justify-center">
            <div className="w-24 h-24 rounded-full border-4 border-stone/10 relative flex items-center justify-center">
                {/* Spinner Track */}
                <div className="absolute inset-0 rounded-full border-4 border-amber border-t-transparent border-r-transparent animate-spin" />
                ...
                <div className="absolute bottom-[-10px] bg-moss text-white text-[0.6rem] font-bold px-2 py-0.5 rounded-full shadow-md flex items-center gap-1 animate-bounce-in">
    ...
    return (
        <div className="relative w-full h-full flex items-center justify-center">
            ...
            {[0, 120, 240].map((deg, i) => (
                ...
                >
                    <div className="absolute top-0 -translate-y-1/2 w-8 h-8 bg-white rounded-lg shadow-sm border border-stone/10 flex items-center justify-center"
                        style={{ transform: `rotate(-${deg}deg)` }}>
