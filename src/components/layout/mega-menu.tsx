...
import { ChevronDown, ArrowRight, UserPlus, Zap, BarChart3, ShieldCheck } from 'lucide-react';
                ...
                <AnimatePresence>
                    {activeMenu === 'who-we-help' && (
                        <motion.div
                            ...
                            className="absolute top-[calc(100%+0.5rem)] left-1/2 -translate-x-1/2 w-[90vw] max-w-[800px] z-50 p-6 mega-menu-panel"
                        >
                            ...
                            <div className="mt-6 pt-4 border-t border-stone/10 text-center">
                                <p className="text-stone-light text-xs italic font-body">
                                    "Every system we build is purpose-made for clinics with 5–50 staff who want to grow without the guesswork."
                                </p>
                            </div>
                        </motion.div>
                    )}
                ...
                <AnimatePresence>
                    {activeMenu === 'services' && (
                        <motion.div
                            ...
                            exit={{ opacity: 0, y: 5 }}
                            transition={{ duration: 0.2 }}
                            className="absolute top-[calc(100%+0.5rem)] left-1/2 -translate-x-1/2 w-[90vw] max-w-[900px] z-50 p-6 mega-menu-panel"
                        >
                            <div className="grid grid-cols-3 gap-6">
                                <ServiceItem
                                    icon="📢"
